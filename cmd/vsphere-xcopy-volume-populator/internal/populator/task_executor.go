...
func UpdateTaskStatus(ctx context.Context, task *vmkfstoolsTask, executor TaskExecutor, host *object.HostSystem, taskId string, progress chan<- uint64, xcopyUsed chan<- int) (*vmkfstoolsTask, error) {
